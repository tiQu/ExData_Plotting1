...
## 2. Creating Plot 4
# 2.a Opening device and setting parameters for mfrow
png(filename = "plot4.png", width = 480, height = 480)
par(mfrow = c(2, 2))

# 2.b Plot I
plot(power_data$datetime, power_data$Global_active_power, pch=".",
     ylab = "Global Active Power",
     xlab = "")
lines(power_data$datetime, power_data$Global_active_power)

# 2.c Plot II
plot(power_data$datetime, power_data$Voltage, pch=".",
     ylab = "Voltage",
     xlab = "datetime")
...
legend("topright", legend = names(power_data)[7:9], col = c("black","red","blue"), pch = "—", bty = "n")

# 2.d Plot IV
plot(power_data$datetime, power_data$Global_reactive_power, pch=".",
